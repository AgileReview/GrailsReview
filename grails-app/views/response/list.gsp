                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="response.answer.label" default="Answer" /></th>
                        
                            <th><g:message code="response.question.label" default="Question" /></th>
                        
                            <th><g:message code="response.review.label" default="Review" /></th>
                    ...
                    <g:each in="${responseInstanceList}" status="i" var="responseInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: responseInstance, field: "answer")}</td>
                        
                            <td>${fieldValue(bean: responseInstance, field: "question")}</td>
                        
                            <td>${fieldValue(bean: responseInstance, field: "review")}</td>
