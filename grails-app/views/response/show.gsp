            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="response.answer.label" default="Answer" /></td>
                            
                            <td valign="top" class="value"><g:link controller="answer" action="show" id="${responseInstance?.answer?.id}">${responseInstance?.answer?.encodeAsHTML()}</g:link></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="response.review.label" default="Review" /></td>
                            
                            <td valign="top" class="value"><g:link controller="review" action="show" id="${responseInstance?.review?.id}">${responseInstance?.review?.encodeAsHTML()}</g:link></td>
