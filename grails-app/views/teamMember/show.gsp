            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="teamMember.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: teamMemberInstance, field: "id")}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="role" action="show" id="${teamMemberInstance?.role?.id}">${teamMemberInstance?.role?.name?.encodeAsHTML()}</g:link></td>
